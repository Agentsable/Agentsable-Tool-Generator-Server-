// ---------------------------------------------------------------------------
// MIRROR FILE — do not diverge.
//
// This file mirrors `docs/llm_generated/ToolContract.ts` VERBATIM (the types
// below are copied unchanged). It exists here so that a tool mounted in the
// local Deno server can `import type { ... } from "/core/contracts/ToolContract.ts"`
// exactly the way it will on the production Simple Tools Server (STS).
//
// If the spec in docs/llm_generated/ToolContract.ts changes, re-copy it here.
// ---------------------------------------------------------------------------

// /core/contracts/ToolContract.ts
//
// Tool Contract V2. The authoring rules live in 02-tool-authoring-guide.md
// ("STS Tool Format & Guidelines"); this file is the type that enforces them.
